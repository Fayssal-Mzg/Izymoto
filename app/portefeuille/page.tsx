...
export const metadata: Metadata = {
  title: "Forfaits Izymoto — Rechargez et profitez de bonus exclusifs",
  description:
    "Créez votre forfait Izymoto, rechargez à votre rythme et bénéficiez jusqu'à 20 % de bonus offert. Transparent, sans engagement, valable 24 mois.",
  alternates: { canonical: "/portefeuille" },
  openGraph: {
    title: "Forfaits Izymoto — Bonus jusqu'à 20 % à chaque recharge",
    description:
      "Rechargez votre forfait Izymoto et économisez sur tous vos trajets moto-taxi. Offre particuliers et grands comptes.",
...
const faqItems = [
  ...
  {
    q: "Puis-je partager mon forfait avec mes proches ou collaborateurs ?",
    a: "Pour les particuliers, le forfait est personnel. Pour les entreprises, l'admin peut inviter ses collaborateurs et leur attribuer un budget mensuel individuel depuis l'espace grand compte.",
  },
  {
  ...
  return (
    <div className="bg-white">
      <section className="relative overflow-hidden bg-navy-950 text-white">
        <Halo />
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 lg:py-28">
      ...
      <section id="comment-ca-marche" className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="w-16 h-1 bg-navy-950 mx-auto mb-4" />
            <p className="text-base md:text-lg text-navy-600 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Le bonus est crédité instantanément sur votre forfait. Plus vous rechargez, plus le bonus est élevé.",
              },
              {
                icon: Wallet,
                step: "03",
              ...
              >
                ...
                <div className="w-12 h-12 rounded-full bg-navy-950 flex items-center justify-center mb-5">
      ...
      <FaqSection
        ...
        subtitle="Une transparence totale"
        jsonLdId="faq-forfaits"
      />

      <section
        id="portefeuille-cta"
        className="relative overflow-hidden bg-navy-950 py-16 md:py-24 text-white"
      >
        <Halo />
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-base md:text-lg mb-10 max-w-xl mx-auto">
              ...
              équipes activent votre forfait manuellement sur simple demande.
            </p>
