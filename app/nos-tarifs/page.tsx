    ...
    <div className="container mx-auto px-4 py-8">
          ...
          <table className="min-w-full bg-white border border-gray-200 shadow-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="py-3 px-4 border-b font-semibold text-right">
                  Coût en EUR
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              <tr className="hover:bg-gray-50">
                <td className="py-3 px-4 border-b">
                  Annulation à moins de 2 heures
                </td>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            Tarifs applicables hors conditions exceptionnelles et grands
            évènements.
          </li>
          <li>
            Pour les destinations PARIS ⇒ Petite couronne: minimum de 90 EUR.
          </li>
          <li>
            Toutes destinations possibles: prise en charge 30 EUR + 2 EUR / km
            (hors Paris limitrophe).
          </li>
          <li>
            Réservation à moins de 2h: augmentation forfaitaire de 20 EUR.
          </li>
          <li>
            Réservation après 21h pour le lendemain matin: augmentation
            forfaitaire de 20 EUR.
          </li>
      ...
      <section className="mb-12 bg-gray-50 p-6 rounded-lg">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            Les clients ne règlent pas directement après la course au chauffeur,
            mais sur facture, envoyée par email ou courrier et paiement à
            réception.
          </li>
          <li>
            Les paiements par cartes CB et American Express sont acceptés.
          </li>
          <li>
            <strong>Paiement en ligne possible sur demande.</strong>
          </li>
        </ul>
      </section>
